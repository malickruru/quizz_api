...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [
                "id" => 6,
                "question" => "Dans quel pays se trouve Ankara, ville nouvelle aux origines pourtant très anciennes ?",
                "propositions" => [
                    "Inde",
                    "Birmanie",
                    "Pakistan",
        ...
        foreach ($data as $item) {
            ...
            $question = Question::create([
                'libelle_question' => $item['question'],
                'reponse' => array_search($item['réponse'], $item['propositions']),
            ]);
            // 2.créér les proposition
          
            foreach ($item['propositions'] as $key => $value) {
